---
title: "Clustering based on HHS measures adopted"
...
survey_data_path <- paste0(
  ROOT_URL, 
  "raw/data/business_data_20210531.xlsx"
)
...
# Preview
knitr::kable(
  businesses_hhs[1:6, 1:9], caption = 'A subset of businesses_hhs'
)
```
...
businesses_hhs$lat <-as.numeric(
  as.character(businesses_hhs$coord[[1]])
  )

businesses_hhs$lng <- as.numeric(
  as.character(    businesses_hhs$coord[[2]])
  )
...
leaflet(data = onlyLatLng, width = "100%") %>% 

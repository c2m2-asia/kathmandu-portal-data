...
Our survey forms are designed using the open source XForm standard. We realized that there was a need to re-evaluate how variable names are assigned in the XLSForm. The motivation was to reduce any manual effort post survey that is spent on data preprocessing. In this context, we have the following suggestions for anyone designing a survey using XLSForm:
